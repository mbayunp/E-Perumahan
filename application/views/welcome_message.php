        ...
        <div class="navbar-wrapper  ">
            <div class="navbar-content scroll-div ">
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item">
                        <a href="<?= base_url() ?>warga" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-life-buoy"></i></span><span class="pcoded-mtext">Data
                                Warga</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= base_url() ?>iuran" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-cloud-lightning"></i></span><span class="pcoded-mtext">Data
                                Iuran</span></a>
                    </li>
                    <li class="nav-item">
